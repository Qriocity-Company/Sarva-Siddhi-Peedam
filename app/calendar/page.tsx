    ...
    return (
        <div className="w-full text-white font-khand relative">
            ...
            <div className="absolute left-[10%] top-1/2 -translate-y-1/2 w-[80%] md:w-[50%] flex flex-col gap-y-4 md:gap-y-6">
                ...
                <button className="w-fit text-white font-[700] text-[14px] md:text-[18px] leading-[25px] bg-black px-6 md:px-10 py-2 md:py-3 rounded-md border-none " onClick={()=>setOpen(true)}>Register Now</button>
            </div>
